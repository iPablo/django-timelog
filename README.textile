...
In the near future there are plans to enhance this library to support

* Simple UI for viewing results that can be incorporated into your own applications
* Filtering results by date and time
* Output further debugging information for slow queries

Of course, if anyone likes this fork of the django-timelog library, and wants to suggest/contribute new features, changes or improvements, they are more than welcome.
